...
// fetch data form server (All Assignments)
  ...
  return (
    <Fade>
      <div className='mt-16  -mb-10 pb-10'>
   ...
   <h1 className='text-2xl md:text-4xl lg:text-5xl text-center font-bold text-lime-400 px-2 md:w-11/12 lg:w-10/12 xl:w-8/12'> Meet, chat, and study with students from all over the world
   </h1>
  ...
  <h1 className='text-3xl md:text-4xl lg:text-5xl text-center font-bold text-orange-500'> POPULAR ASSIGNMENT'S
   ...
   <h1 className='text-md text-center font-bold  mt-5'> We have monthly 1000+ request to be joined assignment's exm.
   </h1>
  </div>
    ...
    {
      loadingSpinner ? <Loading/> : <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-10 mb-10 max-w-[1400px] mx-auto'>
      {
